...
words = (
    "cat", "dog", "fox", "cow", "pig", "hen", "bat", "ant", "emu", "owl",
    "bee", "elk", "ram", "yak", "asp", "cod", "gnu", "koi", "mew", "jay",

    "rabbit", "parrot", "jaguar", "toucan", "falcon", "donkey", "giraffe",
    "hamster", "leopard", "penguin", "gorilla", "dolphin", "octopus",
    "ostrich", "peacock",
